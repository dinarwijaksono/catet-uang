...
use App\Http\Controllers\ModernArt\ReportController as ModernArtReportController;
...
Route::get('/report/modern-art', [ModernArtReportController::class, 'index'])->middleware('auth');
