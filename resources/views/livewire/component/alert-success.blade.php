<div @class(['py-2 px-4', 'hidden' => $hidden])>
    <div role="alert" class="alert shadow-lg text-success">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="stroke-success h-6 w-6 shrink-0">
        ...
        <button type="button" wire:click="doHide" class="btn btn-circle btn-sm">
            <svg xmlns="http://www.w3.org/2000/svg" class="fill-success h-10 w-10"
